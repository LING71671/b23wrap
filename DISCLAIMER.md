...
代码以 [GNU GPL v3](./LICENSE) 授权。  
**GPL 许可不减免你对本免责声明的遵守义务。** 若 GPL 与本声明在「责任限制 / 禁止用途」上可并存，则二者同时适用。
...
Source code is under the [GNU GPL v3](./LICENSE). This disclaimer applies in addition to the GPL license terms where compatible.
